...
static CanMessage_t canQueue
    [MAX_QUEUE_SIZE];  // TODO: Get rid of this for FreeRTOS queue or something.
...
* @retval None
*/
void can_send_comm_data(CAN_HandleTypeDef* hcan, int16_t* send_data,
                        uint32_t comm_id) {
