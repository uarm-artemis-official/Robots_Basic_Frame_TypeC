// This is a configuration file for kiddie mode settings.
// Kiddie mode is a dialed down version from normal competition settings.
// It is intended to be used for events involved younger children where
// they can safely interact with the robot without risk of injury.
// This configuration is not maintained like the other robot modes.
#ifndef __KIDDIE_MODE_CONFIG_HPP
#define __KIDDIE_MODE_CONFIG_HPP
